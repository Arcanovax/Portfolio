...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    // make the canvas cover the viewport and sit behind page content
    ...
    // don't block pointer events to page content — we'll listen on window instead
    ...
    // listen to window resize so the fixed background always matches viewport
